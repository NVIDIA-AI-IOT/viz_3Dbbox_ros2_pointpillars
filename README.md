...
2. `run_all_pcs.py` - Runs PointPillars inference for all bin files in a folder. Please follow the steps given [here](https://catalog.ngc.nvidia.com/orgs/nvidia/teams/tao/models/pointpillarnet)
